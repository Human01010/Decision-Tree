...
data_encoded = data.apply(label_encoder.fit_transform)  # Apply label encoding to all columns
features = data_encoded.columns[1:]  # Updated features after encoding
